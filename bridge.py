...
while True:
    ...
    for server in servers:
        ...
        payload = {"action": "server", "data": {"id": id, "ip": ip, "port": port, "created": created, "lifesign": int(time.time()), "private": private, "remote": 1, "origin": "bridge", "version": version, "mode": mode, "players": players, "max": max, "name": name}}
